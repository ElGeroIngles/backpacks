...
execute as @e[tag=backpacks.backpack_menu] if score @s backpacks.id = @p[tag=backpacks.backpack_menu_this_player_interaction] backpacks.id run say sadsad
execute as @e[tag=backpacks.backpack_menu] if score @s backpacks.id = @p[tag=backpacks.backpack_menu_this_player_interaction] backpacks.id run function senti:start
