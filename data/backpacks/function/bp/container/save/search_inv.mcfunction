...
$execute if items entity @p[tag=backpacks.backpack_menu_save_this_player,tag=backpacks.offhand] weapon.offhand *[minecraft:custom_data~{backpacks:{init:{id:$(id)}}}] run data modify storage backpacks:temp item.slot set value "weapon.offhand"
