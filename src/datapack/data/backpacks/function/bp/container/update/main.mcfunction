...
execute unless data entity @s Items[].components."minecraft:custom_data".backpacks.contents.pages[0][{components:{"minecraft:custom_data":{menu_backpack:{}}}}].components."minecraft:item_model" run function backpacks:bp/container/update/update_old_models/main
